...
import 'package:rpsbloc/barpage.dart';
...
import 'package:rpsbloc/profile.dart';
                              ...
                              Stack(
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    right: 0,
                                    child: Text(
                                      userdetails.data.notification.toString(),
                                      style: const TextStyle(
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (isAllSelected) {
                                ...
                                transactionlist =
                                    transaction.data.reversed.elementAt(index);
                              } else {
                                        ...
                                        children: [
                                          CircleAvatar(
                                            ...
                                            child: transactionlist.image == ""
                                                ? Text(
                                                    transactionlist.placeholder,
                                                  )
                                                : Image.network(transactionlist
                                                    .image
                                                    .toString()),
                                          ),
                                          Positioned(
